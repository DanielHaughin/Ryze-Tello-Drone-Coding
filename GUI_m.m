classdef GUI_m < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        EmergancyLandButton      matlab.ui.control.Button
...
%% Alarm response   
        ...
        function alarm(app)
            ...
            if contains(t,"A")
                ...
                if app.response == 0
                    ...
                    app.AlertsEditField.Value = respond_A(app.drone,app.cam);
            ...
            elseif contains(t,"B")
                ...
                if app.response == 0
                    ...
                    %Call function to respond to alarm
                    app.AlertsEditField.Value = respond_B(app.drone,app.cam);
    ...
    methods (Access = private)
        ...
        function CheckpointAButtonPushed(app, event)
            ...
            %Call function to respond to alarm
            app.AlertsEditField.Value = monitor_A(app.drone,app.cam,m);
        ...
        function EmergancyLandButtonPushed(app, event)
            
            %Prevent drone from moving
            app.response = 0;
            app.CheckpointAButton.Enable = 'off';
            app.CheckpointBButton.Enable = 'off';
            %display in alerts line
            app.AlertsEditField.Value = 'Emergancy Land';
        ...
        function CheckpointBButtonPushed(app,event)
            ...
            %Call function to respond to alarm
            app.AlertsEditField.Value = monitor_B(app.drone,app.cam,m);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.CheckpointAButton.Interruptible = 'off';
            ...
            app.CheckpointBButton.Interruptible = 'off';
            ...
            % Create EmergancyLandButton
            app.EmergancyLandButton = uibutton(app.EmergancyFunctionsPanel, 'push');
            app.EmergancyLandButton.ButtonPushedFcn = createCallbackFcn(app, @EmergancyLandButtonPushed, true);
            app.EmergancyLandButton.BusyAction = 'cancel';
            app.EmergancyLandButton.Interruptible = 'off';
            app.EmergancyLandButton.Position = [1 53 199 42];
            app.EmergancyLandButton.Text = 'Emergancy Land';
